...
public class PBKDF2 {
    ...
    public static String computePBKDF(char[] password) throws GeneralSecurityException {
        ...
        try {
            ...
            throw new GeneralSecurityException("One of the argument is illegal. Salt " + salt + " is of 0 length,                   iteration count " + ITERATION_COUNT + " is not positive or derived key length " +
        ...
        try {
            ...
            throw new GeneralSecurityException("Specified algorithm " + PDKDF_ALGORITHM + "is not available by the                  provider " + pbkdfKeyFactory.getProvider().getName()) ;}
